        ...
        <div class="card-body px-4 pb-4 pt-3 bg-white">
            ...
            <div class="text-center mb-3">
                <span class="badge text-bg-light border" style="font-size:.78rem;font-weight:600;color:#475569">
                    {{ number_format((float) data_get($product, 'base_weight_grams'), 0, ',', '.') }}g dahil, her +{{ number_format((float) data_get($product, 'extra_weight_step_grams'), 0, ',', '.') }}g icin +{{ number_format((float) data_get($product, 'extra_weight_step_price'), 2, ',', '.') }}₺
                </span>
            </div>
