    ...
    <div class="col-lg-6">
        <div class="sm-card">
            <div class="sm-card-header">
                <i class="bi bi-plus-circle" style="color:#FF6B35"></i>{{ __('products.new_product') }}
            </div>
                ...
                <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" novalidate>
                    ...
                    <div class="mb-3">
                        ...
                        @if($categories->isEmpty())
                            <div class="form-text text-warning">
                                ...
                                {!! __('products.add_category_first', ['link' => route('categories.create')]) !!}
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name"
                               ...
                               value="{{ old('name') }}" placeholder="{{ __('products.name_placeholder') }}" required>
