                ...
                <tr data-id="{{ $product->id }}">
                    ...
                    <td>
                        ...
                        <div style="font-size:.7rem;color:#98a2b3;margin-top:.15rem">
                            {{ number_format((float) data_get($product, 'base_weight_grams'), 0, ',', '.') }}g taban, +{{ number_format((float) data_get($product, 'extra_weight_step_grams'), 0, ',', '.') }}g => +{{ number_format((float) data_get($product, 'extra_weight_step_price'), 2, ',', '.') }}₺
                        </div>
