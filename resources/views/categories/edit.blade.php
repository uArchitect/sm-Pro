...
@section('page-title', __('categories.edit_category'))
@section('content')
<div class="row justify-content-center">
    <div class="col-lg-6">
        <div class="sm-card">
            <div class="sm-card-header">
                <i class="bi bi-pencil" style="color:#6366f1"></i>{{ __('categories.edit_category') }}
            </div>
            <div class="sm-card-body">
                <form method="POST" action="{{ route('categories.update', $category->id) }}" enctype="multipart/form-data" novalidate>
                    @csrf
                    @method('PUT')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="d-flex gap-2 mt-1">
                            <button type="button" class="btn btn-link btn-sm text-danger p-0 {{ $category->image ? '' : 'd-none' }}" id="removeBtn" onclick="removeImg()">
