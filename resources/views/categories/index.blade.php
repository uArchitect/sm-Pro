...
@section('page-help', __('categories.page_help'))
...
.cat-thumb:hover { opacity:.7; box-shadow:0 0 0 2px rgba(79,70,229,.4); }
...
.cat-thumb-empty:hover { background:#fff0eb; color:#4F46E5; border:1px dashed rgba(79,70,229,.4); }
