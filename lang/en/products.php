...
return [
    ...
    'bulk_hint'      => 'Enter multiple products in one go. Set category, name, description (optional), price, and weight (optional) per row. No photo in bulk mode.',
    ...
    'page_help_create'       => 'Add new products to your menu. Weight is optional; when filled, the product price is shown with weight information. Use single mode for detailed entry with photos, or bulk mode to add multiple products quickly.',
    'duplicate'              => 'Duplicate',
    'copy_suffix'            => '(Copy)',
